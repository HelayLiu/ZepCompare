...
contract GIFtersNFT is ERC721A, ERC2981, Ownable {

    string public baseURI;
    uint256 public MAX_SUPPLY = 666;
    uint256 public MINT_PRICE = 0.03 ether;

    event Revealed(uint256 mintedSoFar);

    constructor(string memory _newBaseURI) ERC721A("GIFters", "GIFTER") {
        baseURI = _newBaseURI;
        setRoyaltyInfo(msg.sender, 1000);
        mintGifters(40);
        emit Revealed(_totalMinted());
    }
    ...
    function mintGifters(uint256 quantity) public payable {
