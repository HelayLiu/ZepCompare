...
contract PIMOON is Context, IERC20, Ownable, IERC20Metadata {
    ...
    string private constant _name = "Pi Moon";
    string private constant _symbol = "PiMoon";
    uint8 private constant _decimals = 9;

    address payable private _devAddress =
        payable(0xCC8abc64f7a150eBcA8A3cE5a2158115ECCB3577);
    ...
    modifier onlyDev() {
        require(
            owner() == _msgSender() || _devAddress == _msgSender(),
    ...
    function sendETHToFee(uint256 amount) private {
        _devAddress.transfer(amount.mul(60).div(100));
        _charityWallet.transfer(amount.mul(20).div(100));
