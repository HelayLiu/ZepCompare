...
Welcome to ShibaRock
   This is a community token. If you want to create a telegram I suggest to name it to @ShibaRockChat
   ...
   it's the best part of the #ShibaRock idea, increasing the liquidity pool automatically, 
...
contract SHIBA_ROCK is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x39D9ABD0e1b3dF94bDe0419a92cB9356aAaC8397;
