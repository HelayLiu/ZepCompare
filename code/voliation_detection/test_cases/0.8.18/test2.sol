...
// File: contracts/ExenoToken_L2.sol
...
contract ExenoToken_L2 is
    Ownable, ERC165, ERC1363, IExenoToken
{
    ...
    function burn(address beneficiary, uint256 amount)
        external override onlyManager
    {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, ERC1363) returns(bool) {
        return interfaceId == type(IExenoToken).interfaceId || super.supportsInterface(interfaceId);
    }
}