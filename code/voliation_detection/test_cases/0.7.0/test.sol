 ...
 */
contract SkiBEP20 is Context, AccessControl, Ownable, BEP20Burnable, BEP20Pausable {
    using SafeMath for uint256;
    ...
    constructor(string memory contractName, string memory contractSymbol, uint256 initialAmount, uint8 decimals) BEP20(contractName, contractSymbol) {
    ...
    function renounceOwnership() public pure override {
        revert("SkiBEP20: renounceOwnership function was disabled; please use transferOwnership");
    }
     ...
     */
    modifier onlyMinter() {
        require(hasRole(MINTER_ROLE, _msgSender()), "SkiBEP20: MINTER role required");
        _;
    }
     ...
     */
    modifier onlyPauser() {
        require(hasRole(PAUSER_ROLE, _msgSender()), "SkiBEP20: PAUSER role required");
        _;
    }
...
contract SKI is SkiBEP20 {
    constructor() SkiBEP20("Skillchain", "SKI", 0, 18) {
    }
