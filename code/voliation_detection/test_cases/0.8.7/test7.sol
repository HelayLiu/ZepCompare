...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8); //the reward token you want distributed 
...
contract MUULINU is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x1818937a16F136479ddA3810AF5d65696E641Ea2;
    address _autoLiqLocker = 0xf3da1b73Cd011Ff0183A21bF3054c479f911189e;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Muu Linu";
    string constant _symbol = "MLINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    
    //max transaction amount: 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = _autoLiqLocker;
