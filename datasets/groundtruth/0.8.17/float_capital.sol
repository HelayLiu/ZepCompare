...
// contracts/abstract/ProxyNonPayable.sol
...
// contracts/interfaces/IAccessControlledAndUpgradeable.sol

interface IAccessControlledAndUpgradeable {
  function ADMIN_ROLE() external returns (bytes32);
}

// contracts/interfaces/IGEMS.sol
...
// contracts/interfaces/IMarketCommon.sol
...
// contracts/interfaces/IMarketExtended.sol
...
interface IPoolToken is IERC20Upgradeable {
  ...
  function initialize(
    IMarketExtendedCore.SinglePoolInitInfo memory poolInfo,
    address upgrader,
    uint32 _marketIndex,
    uint8 _poolTier
  ) external;
...
// contracts/market/template/MarketStorage.sol
